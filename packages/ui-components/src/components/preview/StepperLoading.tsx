...
type propType = { txhash: string | null; isLocalSwap: boolean; fromChainID: SupportedChainId | null; setTxBack?: (hash: string) => void }

const StepperLoading: FC<propType> = ({ txhash, isLocalSwap, fromChainID, setTxBack }) => {
  const statusMint = useStatusMintTxt(txhash, isLocalSwap, fromChainID)
  ...
  return (
    <>
      ...
      <When condition={step == 4}>
        <div className="p-4 mb-4 text-sm  text-center text-red-400 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-green-400" role="alert">
